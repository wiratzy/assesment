    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="col">
                    <div class="card" style="width: 100%; cursor:pointer;"    onclick='addToCart("{{ $item->id }}", "{{ $item->nama_makanan }}", {{ $item->harga }})'>
                        <img src='{{ url("/daftar-gambar/$item->gambar") }}' class="card-img-top" alt="..." width="50px" height="100px">
                        <div class="card-body">
